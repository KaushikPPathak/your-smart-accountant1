...
const N = Number(process.env.STRESS_N ?? 100_000);

// Thresholds — generous headroom over observed timings; tighten as we optimise.
const T_SEED_MS = 600_000;
const T_BACKUP_MS = 600_000;
const T_RESTORE_MS = 600_000;
const T_COUNT_MS = 60_000;
const T_INVARIANT_MS = 60_000;
