...
const DEFAULT_CREDS: SetuCreds = {
  ...
  clientSecret: "df93df0e036268e83bcffd824287952374c0b4aa624c25bc52df419f084a4743", // YOUR NEW KEY
  productInstanceId: "",
...
export function loadSetuCreds(): SetuCreds {
  try {
    // Auto-clean the old broken cache so the new key can take effect
